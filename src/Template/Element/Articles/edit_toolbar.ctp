<div class="card card-outline-secondary">
    <?= $this->Form->button($this->Html->tag('span', '', array('class' => 'fa fa-refresh fa-lg')).  __('&nbsp;Save'),
                array('escape'=>false,'class' => 'btn btn-sm btn-success ml-1 my-1','formnovalidate' => true, 'name' => 'save1')
    ) ?>
    <?= $this->Form->button($this->Html->tag('span', '', array('class' => 'fa fa-check-square-o fa-lg')).  __('&nbsp;Save&close'),
                array('escape'=>false,'class' => 'btn btn-sm btn-outline-success ml-1 my-1','formnovalidate' => true, 'name' => 'save2')
    ) ?>
    <?= $this->Form->button($this->Html->tag('span', '', array('class' => 'fa fa-plus-square fa-lg')).  __('&nbsp;Save+New'),
                array('escape'=>false,'class' => 'btn btn-sm btn-info ml-1 my-1','formnovalidate' => true, 'name' => 'save3' )
    ) ?>
